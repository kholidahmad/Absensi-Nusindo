<head>
    ...
    <meta name="description" content="Absensi Karyawan" />
	<meta name="keywords" content="absensi, karyawan, karyawan management, Absensi Karyawan, kantor management" />
    ...
    input, select, option, textarea, .badge, .form-group, .form-control, .custom-select, .nav-link.card, .nav-item.nav-link{
        border-radius: 10px;
    }
    .btn {
        border-radius: 20px;
    ...
    <!-- TINY -->
    <!-- <script src="https://cdn.tiny.cloud/1/w42ruakce0aojadqw65cyk5zoijciu3vrt0ea8f94cthtu2w/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script> -->
    <script>
    //   tinymce.init({
    //   selector: 'textarea',
