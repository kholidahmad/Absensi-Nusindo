      ...
      <nav>
          <div class="nav nav-tabs mb-4" id="nav-tab" role="tablist">
              <a class="nav-item nav-link active pl-4 pr-4" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">   <b>Sakit</b>  </a>
              <a class="nav-item nav-link pl-4 pr-4" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"><b>Pribadi </b></a>
              <a class="nav-item nav-link pl-4 pr-4" id="nav-libur-tab" data-toggle="tab" href="#nav-libur" role="tab" aria-controls="nav-libur" aria-selected="false"><b>Libur </b></a>
              <a class="nav-item nav-link pl-4 pr-4" id="nav-tahunan-tab" data-toggle="tab" href="#nav-tahunan" role="tab" aria-controls="nav-tahunan" aria-selected="false"><b>Tahunan </b></a>
          </div>
      </nav>
                              ...
                              <tr>
                                  ...
                                  <td>  
                                    <?php if($rows->lampiran_izin != null):?>
                                        <button class="btn btn-outline-danger btn-sm mt-2" onClick="hapusIzinFile('<?= $rows->kode_izin; ?>','<?= $rows->lampiran_izin; ?>')"><i class="fas fa-fw fa-times-circle"></i> STOP</button>
                                    <?php else :?>
                                        <button class="btn btn-outline-danger btn-sm mt-2" onClick="hapusIzin('<?= $rows->kode_izin; ?>')"><i class="fas fa-fw fa-times-circle"></i>  STOP</button>
                                    <?php endif; ?>
                                  </td>
                              </tr>
                              <?php } ?>
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
              <div class="table-responsive">
                  <div class="card-body">
                      <div class="">
                          <h3 class="card-title text-center">Daftar Pegawai izin Pribadi</h3>
                      </div>
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
              <div class="card-body">
              <div class="">
                    <h3 class="card-title text-center">Daftar Pegawai Libur</h3>
                </div>
                  <div class="table-responsive">
