...
<body>
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <!-- end pageheader  -->
                    <!-- ============================================================== -->
                    <?php $this->load->view('admin/layouts/MenuMasterDivisi'); ?>
    ...
    function hapusDivisi(id){
            ...
            if (result.value) {
                $.ajax({
                url: "<?php echo (base_url().'Karyawan/deleteDivisi'); ?>",
                method: 'POST',
                dataType: 'json',
                data: {
                    id: id
                ...
                success: function(data) {
                    ...
                    setTimeout(function() {
                    window.location.href = "<?php echo (base_url().'karyawan/master_divisi'); ?>";
                    }, 1100);
