    ...
    <!-- SweetAlert2 -->
    <!-- <script src="<?php echo base_url(); ?>assets/vendor/sweetalert2/dist/sweetalert2.all.js"></script> -->
    ...
    <script src="<?php echo base_url('assets/vendor/swal-forms-master/swal-forms.js') ?>"></script> -->
    <!-- INPUTMASK -->
    <script src="<?php echo base_url('assets/vendor/input-mask/jquery.inputmask.js') ?>"></script>
    <script src="<?php echo base_url('assets/vendor/input-mask/jquery.inputmask.date.extensions.js') ?>"></script>
    <script src="<?php echo base_url('assets/vendor/input-mask/jquery.inputmask.extensions.js') ?>"></script>
    ...
    <!-- PDF -->
    <script src="<?php echo base_url('assets/vendor/pdfobject/pdfobject.min.js') ?>"></script>
