        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Izin Pribadi</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <!-- end pageheader  -->
                    <!-- ============================================================== -->
                    <?php $this->load->view('user/layouts/MenuIzinSaya'); ?>
    ...
    function batalIzinKarFile(kode_izin, lampiran_izin){
        ...
        if (result.value) {
            ...
            success: function(data) {
                ...
                setTimeout(function() {
                window.location.href = "<?php echo (base_url().'user/Izin_saya'); ?>";
                }, 1100);
